...
export class TeamsBot extends TeamsActivityHandler {
  ...
  private async listActiveAgents(turnContext: TurnContext): Promise<any> {
    ...
    if (useTestData) {
      // Hardcoded list of agents for testing
      return {
        data: {
          affected_items: [
            { id: "001", name: "Agent 1", ip: "192.168.1.1", status: "Active" },
            { id: "002", name: "Agent 2", ip: "192.168.1.2", status: "Disconnected" },
            { id: "003", name: "Agent 3", ip: "192.168.1.3", status: "Active" },
          ],
  ...
  async onAdaptiveCardInvoke(
    ...
    if (invokeValue.action.verb == "listagent"){
      ...
      console.log('Using hardcoded agents list for testing');
      this.runningAgents = agentsList;
      await context.sendActivity('Agents list obtained and stored.');
    }
    else{
